        ...
        return _inherits(b, a), _createClass(b, null, [{
            ...
            value: function() {
                this.prototype.Emitter = Emitter, this.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "addedfiles", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached", "queuecomplete"], this.prototype.defaultOptions = {
                    ...
                    renameFile: null,
                    forceFallback: !1,
                    dictDefaultMessage: "拖拽文件到此处 或 点击选择文件 上传",
                    dictFallbackMessage: "您的浏览器不支持拖放文件上传。\r\nYour browser does not support drag'n'drop file uploads.",
                    dictFallbackText: "Please use the fallback form below to upload your files like in the olden days.",
                    dictFileTooBig: "文件大于{{filesize}}MiB 文件最大限制: {{maxFilesize}}MiB \r\nFile is too big ({{filesize}}MiB). Max filesize: {{maxFilesize}}MiB.",
                    ...
                    dictCancelUploadConfirmation: "确定要取消此上传吗？\r\nAre you sure you want to cancel this upload?",
                    dictRemoveFile: "删除文件\r\nRemove file",
...
Dropzone.createElement = function(a) {
    ...
    } else null != a.nodeType && (d = [a]); if (null == d || !d.length) throw new Error("Invalid `" + b + "` option provided. Please provide a CSS selector, a plain HTML element or a list of those.");
    return d
